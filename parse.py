...
def yelp_params():
    ...
    parser.add_argument('--encoder_epochs', type=int,default=95)  ### 1 
    parser.add_argument('--gsl_epochs', type=int,default=5)  ### 1 

    parser.add_argument('--r_add', type=float,default=2) ### 2
    parser.add_argument('--r_dele', type=float,default=100.0) ### 2
    parser.add_argument('--min_keep', type=float, default=0.1)  ### 2
    parser.add_argument('--max_add', type=float, default=0.1)  ### 2
...
def flickr_params():
    ...
    parser.add_argument('--lr_encoder', type=float,default=0.001, help="")  ### 1 
    parser.add_argument('--lr_gsl', type=float,default=0.001, help="")  ### 1 
    parser.add_argument('--add_weight', type=float,default=0.5)  ### 1 

    parser.add_argument('--r_add', type=float,default=10)
    parser.add_argument('--r_dele', type=float,default=100)
    parser.add_argument('--encoder_epochs', type=int,default=90)  ### 1 
    parser.add_argument('--gsl_epochs', type=int,default=10)  ### 1 
    parser.add_argument('--min_keep', type=float, default=0.1)  ### 2
    parser.add_argument('--max_add', type=float, default=0.1)  ### 2

    ## me
    parser.add_argument('--m_head', type=int,default=1)  ### 2  must 1
    parser.add_argument('--dropout', type=float,default=0.)  ### 2
    parser.add_argument('--tot_epochs', type=int,default=100)  ### 2
